...
public class Constants {
    ...
    public static final Coordinate TREE_AREA = new Coordinate(3069, 3257, 0);
    public static final Coordinate OAK_TREE_AREA = new Coordinate(3033, 3264, 0);
    public static final Coordinate WILLOW_TREE_AREA = new Coordinate(3056, 3251, 0);
