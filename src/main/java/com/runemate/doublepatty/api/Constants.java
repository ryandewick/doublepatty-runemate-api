...
public class Constants {
    ...
    // Coordinates
    public static final Area DRAYNOR_BANK = new Area.Rectangular(new Coordinate(3090, 3245, 0), new Coordinate(3094, 3241, 0));
...
//    public static final Coordinate DRAYNOR_BANK =  new Coordinate(3092, 3243, 0);
    ...
    public static final Area OAK_TREE_AREA = new Area.Rectangular(new Coordinate(3033, 3264, 0), new Coordinate(3040, 3273, 0));
