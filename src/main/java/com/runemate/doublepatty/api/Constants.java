...
public class Constants {
    ...
    public static final Coordinate TREE_AREA = new Coordinate(3080, 3269, 0);
    public static final Coordinate OAK_TREE_AREA = new Coordinate(3048, 3267, 0);
    public static final Coordinate WILLOW_TREE_AREA = new Coordinate(3060, 3253, 0);
